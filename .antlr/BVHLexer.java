...
public class BVHLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"HIERARCHY", "ROOT", "JOINT", "END", "SITE", "OFFSET", "CHANNELS", "MOTION", 
			"FRAMES", "FRAME", "TIME", "Xposition", "Yposition", "Zposition", "Xrotation", 
			"Yrotation", "Zrotation", "LBRACE", "RBRACE", "COLON", "IDENT", "SIGN", 
			"INT", "FLOAT", "EXP", "NL", "WS", "COMMENT"
		};
	}
	...
	public BVHLexer(CharStream input) {
		super(input);
